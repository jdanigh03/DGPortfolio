    ...
    <section class="projects section" id="projects">
        ...
        <div class="container">
            ...
            <div class="projects-container grid">
                <!-- Project 1: Young Engineers Bolivia -->
                <div class="project-card mix backend">
                    ...
                    <div class="project-content">
                        ...
                        <div class="project-technologies">
                            ...
                            <i class="fa-solid fa-database tech-icon" title="MySQL"></i>
                ...
                <div class="project-card mix backend">
                    ...
                    <div class="project-content">
                        ...
                        <div class="project-technologies">
                            <i class="fa-brands fa-laravel tech-icon" title="Laravel"></i>
                            <i class="fa-brands fa-php tech-icon" title="PHP"></i>
                            <i class="fa-solid fa-database tech-icon" title="SQL Server"></i>
                        </div>
                ...
                <div class="project-card mix backend">
                    ...
                    <div class="project-content">
                        ...
                        <div class="project-technologies">
                            ...
                            <i class="fa-solid fa-fire tech-icon" title="Firebase"></i>
                        </div>
                ...
                <div class="project-card mix backend">
                    ...
                    <div class="project-content">
                        ...
                        <div class="project-technologies">
                            ...
                            <i class="fa-brands fa-node-js tech-icon" title="Node.js"></i>
                            <i class="fa-brands fa-js tech-icon" title="JavaScript"></i>
                            <i class="fa-solid fa-database tech-icon" title="PostgreSQL"></i>
                        </div>
